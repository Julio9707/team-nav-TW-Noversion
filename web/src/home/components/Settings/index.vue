      ...
      <div>
        <div class="setting-drawer-content">
          <div class="setting-drawer-title">
            <h3 class="drawer-title">主題風格設定</h3>
          </div>
          <div class="setting-drawer-block-checbox">
            <div class="setting-drawer-block-checbox-item" @click="handleTheme('theme-dark')">
              ...
              <div v-if="sideTheme === 'theme-dark'" class="setting-drawer-block-checbox-selectIcon"
                   style="display: block;">
                <i aria-label="圖示: check" class="anticon anticon-check">
        ...
        <el-divider/>
        <h3 class="drawer-title">系統佈局設定</h3>

        <div class="drawer-item">
          <span>菜單設定</span>
          <el-checkbox-group v-model="menuSetting">
            <el-checkbox label="open">默認展開</el-checkbox>
            <el-checkbox label="accordion">手風琴</el-checkbox>
          </el-checkbox-group>
        </div>
        <div class="drawer-item">
          <span>卡片圖示</span>
          <el-radio-group v-model="cardIconShape">
            <el-radio label="circle">圓形</el-radio>
        ...
        <div class="drawer-item">
          ...
          <el-radio-group v-model="cardSize">
            <el-radio label="small">較小</el-radio>
            <el-radio label="large">較大</el-radio>
          </el-radio-group>
        </div>
        <el-button size="small" type="primary" plain icon="el-icon-document-add" @click="saveSetting">保存設定</el-button>
...
export default {
  ...
  methods: {
    ...
    saveSetting() {
      this.$modal.loading("正在儲存到本地，請稍候...");
    ...
    resetSetting() {
      this.$modal.loading("正在清除設定快取並刷新，請稍候...");
