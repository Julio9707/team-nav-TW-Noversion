      ...
      sidebarRouters: [
        {
          ...
          name: 'category',
          redirect: 'list',
          meta: {title: '分類管理', icon: 'el-icon-menu'},
          children: [
            {
              path: '',
              name: 'category-list',
              meta: {title: '分類列表', icon: 'el-icon-s-operation'}
            },
            {
              path: 'history',
              name: 'category-history',
              meta: {title: '歷史分類', icon: 'el-icon-video-camera-solid'}
            },
          ],
        },
        {
          ...
          children: [
            ...
            },
            {
              path: 'apply',
              name: 'card-apply',
              meta: {title: '申請列表', icon: 'el-icon-message-solid'}
            },
          ],
        },
        {
        ...
        },
        {
          path: '/admin/user',
          name: 'user',
          meta: {title: '帳號管理', icon: 'el-icon-s-custom'}
        },
        {
          path: '/admin/notice',
          name: 'notice',
        ...
        },
        {
          path: '/admin/setting',
          name: 'setting',
          meta: {title: '系統設定', icon: 'el-icon-s-tools'}
        },
      ]
    }
  },
