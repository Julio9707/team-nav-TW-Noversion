  ...
  <div>
    <el-row type="flex" justify="space-between">
      <el-col :span="8">
        <el-upload
          ...
          :limit="1">
          <el-button icon="el-icon-upload" size="small">圖示上傳</el-button>
        </el-upload>
      </el-col>
      <el-col :span="8">
        <el-popover
          ...
          <el-button slot="reference" icon="el-icon-search" size="small">圖示選擇</el-button>
        </el-popover>
      </el-col>
      <el-col :span="8">
    ...
    <el-row>
      <el-col :span="24" class="icon-select-container">
        ...
        <div v-if="iconErrTip" class="el-form-item__error">圖示不能為空，請點擊選擇圖示</div>
      </el-col>
    </el-row>
  </div>
