<template>
  <el-dialog title="圖示裁剪" :visible.sync="show" width="800px" append-to-body :close-on-click-modal="false">
    <el-row>
      ...
      <el-col :xs="24" :md="12" :style="{height: '350px'}">
        ...
        <div class="avatar-file-name">
          <el-input v-model="options.filename" placeholder="請輸入檔案名稱" clearable v-trim></el-input>
        </div>
      </el-col>
    </el-row>
    <br/>
